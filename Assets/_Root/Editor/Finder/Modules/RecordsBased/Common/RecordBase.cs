...
namespace Pancake.Editor.Finder
{
    ...
    public abstract class RecordBase
    {
        ...
        protected RecordBase(RecordLocation location) { Location = location; }
        ...
        public override string ToString() { return GetHeader() + "\n" + GetBody(); }
        ...
        public string ToString(bool clearHtml) { return clearHtml ? StripTagsCharArray(ToString()) : ToString(); }
