namespace Pancake.Editor.Finder
{
    ...
    /// <summary>
    /// Basic item which is used to build results trees at Finder
    /// </summary>
    [Serializable]
    public class TreeItem
    {
        ...
        /// Parent item, if any.
        /// </summary>
        [field: NonSerialized] public TreeItem Parent { get; internal set; }

        /// <summary>
        /// All child items.
        /// </summary>
        [field: NonSerialized] public List<TreeItem> Children { get; internal set; }
        ...
        public bool CanBeFoundWith(string searchString) { return Search(searchString); }

        protected virtual bool Search(string searchString) { return name.IndexOf(searchString, StringComparison.OrdinalIgnoreCase) != -1; }
    }
}