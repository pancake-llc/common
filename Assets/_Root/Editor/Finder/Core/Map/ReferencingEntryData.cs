namespace Pancake.Editor.Finder
{
    ...
    public class ReferencingEntryData
    {
        ...
        /// Full transform path.
        /// </summary>
        public string TransformPath { get { return transformPath; } }
        ...
        [NonSerialized] private StringBuilder labelStringBuilder;

        [NonSerialized] private string label;
        ...
        public string GetLabel()
        {
            ...
            {
                if (needsSpace) labelStringBuilder.Append(": ");
                var nicePropertyPath = ObjectTools.GetNicePropertyPath(propertyPath);
