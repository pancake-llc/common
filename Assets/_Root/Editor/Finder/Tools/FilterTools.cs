namespace Pancake.Editor.Finder
{
    ...
    internal static class FilterTools
    {
        ...
        public static List<AssetInfo> FilterAssetInfos(List<AssetInfo> assets, FilterItem filter) { return FilterAssetInfos(assets, new[] {filter}); }
        ...
        public static List<AssetInfo> FilterAssetInfos(List<AssetInfo> assets, List<TypeFilter> targetAssetTypes, FilterItem[] includes, FilterItem[] ignores)
        {
            var result = new List<AssetInfo>();
        ...
        public static bool IsValueMatchesAnyFilter(string value, FilterItem[] filters) { return IsValueMatchesAnyFilterOfKind(value, filters, FilterKind.NotSet); }
                ...
                switch (filter.kind)
                {
                    ...
                    case FilterKind.Directory:
                        if (directory == string.Empty)
                        {
                            ...
                            if (directory != null) directory = PathTools.EnforceSlashes(directory);
                        }
                    ...
                    case FilterKind.FileName:
                        if (filename == string.Empty)
                        {
                            ...
                            if (filename != null) filename = PathTools.EnforceSlashes(filename);
                        }
