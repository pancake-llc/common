...
/*#if UNITY_2018_2_OR_NEWER
        ...
        public static void SetInspectorToDebug(SerializedObject serializedObject)
        {
            if (inspectorModeCachedSetter == null)
            {
                ...
                if (pi != null)
                {
                    ...
                    if (mi != null)
                    {
                        inspectorModeCachedSetter =
                            (Action<SerializedObject, InspectorMode>) Delegate.CreateDelegate(typeof(Action<SerializedObject, InspectorMode>), mi);
                    }
                    else
                    {
                        Debug.LogError(Finder.ConstructError("Can't get the setter for the SerializedObject.inspectorMode property!"));
                        return;
                    }
                }
                else
                {
                    Debug.LogError(Finder.ConstructError("Can't get the SerializedObject.inspectorMode property!"));
                    return;
                }
            }
        ...
        public static void BeginVerticalSplit(object spl, GUILayoutOption[] guiLayoutOptions)
        {
            ...
            {
                beginVerticalSplitMethodInfo = splitterGUILayoutType.GetMethod("BeginVerticalSplit",
                    BindingFlags.Static | BindingFlags.Public,
                    null,
                    CallingConventions.Standard,
                    new[] {splitterStateType, typeof(GUILayoutOption[])},
                    null);
            }

            if (beginVerticalSplitMethodInfo == null)
            {
                Debug.LogError(Finder.ConstructError("Can't get SplitterGUILayout.BeginVerticalSplit method!"));
                return;
            }
        ...
        public static void EndVerticalSplit()
        {
            ...
            if (endVerticalSplitMethodInfo == null)
            {
                Debug.LogError(Finder.ConstructError("Can't get SplitterGUILayout.EndVerticalSplit method!"));
                return;
            }
        ...
        public static MethodInfo GetOpenProjectSettingsMethodInfo()
        {
            ...
            {
                openProjectSettingsMethodInfo =
                    settingsWindowType.GetMethod("OpenProjectSettings",
        ...
        public static UnityEventBase GetDummyEvent(SerializedProperty property)
        {
            ...
            if (getDummyEventMethodInfo == null)
            {
                Debug.LogError(Finder.ConstructError("Can't get UnityEventDrawer.GetDummyEvent method!"));
                return null;
            }
