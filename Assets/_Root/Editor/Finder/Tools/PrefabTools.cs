namespace Pancake.Editor.Finder
{
    ...
    {
        public static PrefabInstanceStatus GetInstanceStatus(Object componentOrGameObject) { return PrefabUtility.GetPrefabInstanceStatus(componentOrGameObject); }
        ...
        public static bool IsMissingPrefabInstance(GameObject gameObject)
        {
            ...
            return status == PrefabInstanceStatus.MissingAsset || status == PrefabInstanceStatus.NotAPrefab && IsInstance(gameObject) &&
                PrefabUtility.GetNearestPrefabInstanceRoot(gameObject) == null;
        }
        ...
        public static GameObject GetPrefabAssetRoot(string path) { return AssetDatabase.LoadMainAssetAtPath(path) as GameObject; }

        public static GameObject GetInstanceRoot(GameObject gameObject) { return PrefabUtility.GetOutermostPrefabInstanceRoot(gameObject); }

        public static bool IsInstanceRoot(GameObject gameObject) { return PrefabUtility.IsOutermostPrefabInstanceRoot(gameObject); }

        public static bool IsWholeInstanceHasAnyOverrides(GameObject current) { return PrefabUtility.HasPrefabInstanceAnyOverrides(current, false); }
