namespace Pancake.Editor.Finder
{
    ...
    {
        public const int EYE_BUTTON_SIZE = 22;
        public const int WARNING_ICON_SIZE = 16;
        public const int EYE_BUTTON_PADDING = 4;
        ...
        public static void SetupStyles()
        {
            ...
            if (!alreadyExists)
            {
                var markerStyle = new GUIStyle {name = "FinderStyles"};
            ...
            panelWithoutBackground = new GUIStyle(EditorStyles.helpBox) {padding = new RectOffset(), margin = new RectOffset()};
        ...
        public static void VerticalSeparator() { GUILayout.Box(GUIContent.none, line, GUILayout.Width(1f), GUILayout.ExpandHeight(true)); }
        ...
        public static void IndentLevel() { EditorGUI.indentLevel++; }

        public static void UnIndentLevel() { EditorGUI.indentLevel--; }

        public static void Icon(Texture icon, string hint, params GUILayoutOption[] options) { GUILayout.Label(new GUIContent(icon, hint), iconLabel, options); }

        public static void Icon(Rect rect, Texture icon) { Icon(rect, icon, null); }

        public static void Icon(Rect rect, Texture icon, string hint) { GUI.Label(rect, new GUIContent(icon, hint), iconLabel); }

        public static bool ImageButton(string label, Texture image, params GUILayoutOption[] options) { return ImageButton(label, null, image, options); }

        public static bool ImageButton(string label, string hint, Texture image, params GUILayoutOption[] options)
        {
            return ImageButton(label,
                hint,
                image,
                compactButton,
                options);
        ...
        public static bool ImageButton(Rect rect, string label, Texture image) { return ImageButton(rect, label, null, image); }

        public static bool ImageButton(Rect rect, string label, string hint, Texture image)
        {
            return ImageButton(rect,
                label,
                hint,
                image,
                compactButton);
        ...
        public static bool IconButton(Texture icon, params GUILayoutOption[] options) { return IconButton(icon, null, options); }
        ...
        public static bool IconButton(Rect rect, Texture icon) { return IconButton(rect, icon, null); }
        ...
        {
            return record.compactMode
                ? IconButton(image, hint)
                : ImageButton(label,
                    hint,
                    image,
                    recordButton,
        ...
        public static void Foldout(ref bool foldout, string caption, params GUILayoutOption[] options) { Foldout(ref foldout, new GUIContent(caption), options); }

        public static void Foldout(ref bool foldout, GUIContent caption, params GUILayoutOption[] options)
        {
            foldout = EditorGUI.Foldout(EditorGUILayout.GetControlRect(options),
                foldout,
                caption,
                true,
                richFoldout);
        ...
        public static string WrapTextWithColorTag(string input, string color) { return "<color=" + color + ">" + input + "</color>"; }
    }
}