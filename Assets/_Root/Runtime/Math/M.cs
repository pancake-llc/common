...
namespace Pancake.Common
{
    ...
    public static class M
    {
        ...
        [MethodImpl(INLINE)]
        public static int SignAsInt(float value) => value >= 0f ? 1 : -1;
        ...
        [MethodImpl(INLINE)]
        public static float SignWithZero(float value, float zeroThreshold = 0.000001f) => Abs(value) < zeroThreshold ? 0 : Sign(value);
        ...
        public static Vector2 SignWithZero(Vector2 value, float zeroThreshold = 0.000001f) =>
            new Vector2(Abs(value.x) < zeroThreshold ? 0 : Sign(value.x), Abs(value.y) < zeroThreshold ? 0 : Sign(value.y));
        ...
        public static Vector3 SignWithZero(Vector3 value, float zeroThreshold = 0.000001f) =>
            new Vector3(Abs(value.x) < zeroThreshold ? 0 : Sign(value.x),
        ...
        public static Vector4 SignWithZero(Vector4 value, float zeroThreshold = 0.000001f) =>
            new Vector4(Abs(value.x) < zeroThreshold ? 0 : Sign(value.x),
                Abs(value.y) < zeroThreshold ? 0 : Sign(value.y),
                Abs(value.z) < zeroThreshold ? 0 : Sign(value.z),
        ...
        /// <summary>The sign of the value. Returns -1 if negative, return 0 if zero (or within the given threshold), returns 1 if positive</summary>
        [MethodImpl(INLINE)]
        public static int SignWithZeroAsInt(float value, float zeroThreshold = 0.000001f) => Abs(value) < zeroThreshold ? 0 : SignAsInt(value);
        ...
        [MethodImpl(INLINE)]
        public static Vector2 Frac(Vector2 v) => new Vector2(v.x - Floor(v.x), v.y - Floor(v.y));

        /// <inheritdoc cref="M.Frac(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector3 Frac(Vector3 v) => new Vector3(v.x - Floor(v.x), v.y - Floor(v.y), v.z - Floor(v.z));

        /// <inheritdoc cref="M.Frac(Vector2)"/>
        [MethodImpl(INLINE)]
        public static Vector4 Frac(Vector4 v) => new Vector4(v.x - Floor(v.x), v.y - Floor(v.y), v.z - Floor(v.z), v.w - Floor(v.w));
        ...
        /// <inheritdoc cref="M.Lerp(Vector2,Vector2,Vector2)"/>
        [MethodImpl(INLINE)]
        ...
        /// <inheritdoc cref="M.InverseLerp(Vector2,Vector2,Vector2)"/>
        [MethodImpl(INLINE)]
        ...
        /// <summary>Returns the average/center of the two input vectors</summary>
        [MethodImpl(INLINE)]
        public static Vector3 Average(Vector3 a, Vector3 b) => (a + b) / 2f;
        ...
        [MethodImpl(INLINE)]
        public static Vector2 AverageDir(Vector2 aDir, Vector2 bDir) => (aDir + bDir).normalized;

        /// <summary>Returns the average/halfway direction between the two input direction vectors. Note that this presumes both <c>aDir</c> and <c>bDir</c> have the same length</summary>
        [MethodImpl(INLINE)]
        public static Vector3 AverageDir(Vector3 aDir, Vector3 bDir) => (aDir + bDir).normalized;
        ...
        /// <param name="v">The direction to create a 2D orientation from (does not have to be normalized)</param>
        [MethodImpl(INLINE)]
        public static Pose PointDirToPose(Vector2 pt, Vector2 v) => new Pose(pt, DirToOrientation(v));
        ...
        public static Pose Lerp(Pose a, Pose b, float t) =>
            new Pose(Vector3.LerpUnclamped(a.position, b.position, t), Quaternion.SlerpUnclamped(a.rotation, b.rotation, t));
        ...
        [MethodImpl(INLINE)]
        public static Matrix4x4 GetMatrixFrom2DPointDir(Vector2 point, Vector2 tangent)
        {
            Vector2 N = tangent.Rotate90CCW();
            return new Matrix4x4(new Vector4(tangent.x, tangent.y, 0, 0), new Vector4(N.x, N.y, 0, 0), new Vector4(0, 0, 1, 0), new Vector4(point.x, point.y, 0, 1));
        }
        ...
        /// <param name="acceleration">The second derivative of the point in the curve</param>
        [MethodImpl(INLINE)]
        public static Vector3 GetArcNormal(Vector3 velocity, Vector3 acceleration) => Vector3.Cross(velocity, Vector3.Cross(acceleration, velocity)).normalized;

        /// <summary>Returns the frenet-serret (curvature-based) binormal direction at a given point in a curve</summary>
        /// <param name="velocity">The first derivative of the point in the curve</param>
        /// <param name="acceleration">The second derivative of the point in the curve</param>
        [MethodImpl(INLINE)]
        public static Vector3 GetArcBinormal(Vector3 velocity, Vector3 acceleration) => Vector3.Cross(velocity, acceleration).normalized;
        ...
        [MethodImpl(INLINE)]
        public static Vector3 GetNormalFromLookTangent(Vector3 tangent, Vector3 up) => Vector3.Cross(up, tangent).normalized;
        ...
        /// <param name="acceleration">The second derivative of the point in the curve</param>
        [MethodImpl(INLINE)]
        public static Quaternion GetArcOrientation(Vector3 velocity, Vector3 acceleration)
        {
