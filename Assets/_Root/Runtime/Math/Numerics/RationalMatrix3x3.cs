    ...
    public readonly struct RationalMatrix3x3
    {
        ...
        public RationalMatrix3x3 Inverse
        {
            get
            {
                ...
                return new RationalMatrix3x3(A1212,
                    m02 * m21 - m01 * m22,
                    m01 * m12 - m02 * m11,
                    -A0212,
                    m00 * m22 - m02 * m20,
        ...
        public string[,] ToStringMatrix()
        {
            return new[,]
            {
                {m00.ToString(), m01.ToString(), m02.ToString()}, {m10.ToString(), m11.ToString(), m12.ToString()}, {m20.ToString(), m21.ToString(), m22.ToString()}
            };
        }
        ...
        public static RationalMatrix3x3 operator *(RationalMatrix3x3 a, RationalMatrix3x3 b)
        {
            ...
            return new RationalMatrix3x3(GetEntry(0, 0),
                GetEntry(0, 1),
                GetEntry(0, 2),
                GetEntry(1, 0),
                GetEntry(1, 1),
        ...
        public static Matrix3x1 operator *(RationalMatrix3x3 c, Matrix3x1 m) =>
            new(m.m0 * c.m00 + m.m1 * c.m01 + m.m2 * c.m02, m.m0 * c.m10 + m.m1 * c.m11 + m.m2 * c.m12, m.m0 * c.m20 + m.m1 * c.m21 + m.m2 * c.m22);
