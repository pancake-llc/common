...
namespace Pancake.Common
{
    ...
    {
        public static readonly RationalMatrix4x4 Identity = new RationalMatrix4x4(1,
            0,
            0,
            0,
            0,
        ...
        public static readonly RationalMatrix4x4 Zero = new RationalMatrix4x4(0,
            0,
            0,
            0,
            0,
        ...
        public RationalMatrix4x4 Inverse
        {
            get
            {
                ...
                Rational det = m00 * (m11 * A2323 - m12 * A1323 + m13 * A1223) - m01 * (m10 * A2323 - m12 * A0323 + m13 * A0223) +
                ...
                return new RationalMatrix4x4((m11 * A2323 - m12 * A1323 + m13 * A1223),
                    ...
                    (m00 * A1212 - m01 * A0212 + m02 * A0112)) / det;
            }
        }
        ...
        public Rational Determinant
        {
            get
            {
                ...
                Rational A0223 = m20 * m32 - m22 * m30;
                Rational A0123 = m20 * m31 - m21 * m30;
                return m00 * (m11 * A2323 - m12 * A1323 + m13 * A1223) - m01 * (m10 * A2323 - m12 * A0323 + m13 * A0223) +
                    m02 * (m10 * A1323 - m11 * A0323 + m13 * A0123) - m03 * (m10 * A1223 - m11 * A0223 + m12 * A0123);
            }
        }
        ...
        public string[,] ToStringMatrix()
        {
            return new[,]
            {
                {m00.ToString(), m01.ToString(), m02.ToString(), m03.ToString()}, {m10.ToString(), m11.ToString(), m12.ToString(), m13.ToString()},
                {m20.ToString(), m21.ToString(), m22.ToString(), m23.ToString()}, {m30.ToString(), m31.ToString(), m32.ToString(), m33.ToString()}
            };
        }
        ...
        public static RationalMatrix4x4 operator *(RationalMatrix4x4 a, RationalMatrix4x4 b)
        {
            ...
            return new RationalMatrix4x4(GetEntry(0, 0),
                GetEntry(0, 1),
                GetEntry(0, 2),
                GetEntry(0, 3),
                GetEntry(1, 0),
