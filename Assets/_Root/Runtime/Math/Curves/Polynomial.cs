...
namespace Pancake.Common
{
    ...
    public struct Polynomial
    {
        ...
        public Polynomial Compose(float g0, float g1)
        {
            ...
            return new Polynomial(c3 * ooo + c2 * oo + c2g0 + c0, g1 * (_3c3 * oo + 2 * c2g0 + c1), ss * (_3c3 * g0 + c2), sss * c3);
        }
        ...
        public (Polynomial pre, Polynomial post) Split01(float u)
        {
            ...
            Polynomial post = new Polynomial(Eval(u), d * Differentiate(1).Eval(u), dd / 2 * Differentiate(2).Eval(u), ddd / 6 * Differentiate(3).Eval(u));
            return (pre, post);
        }
        ...
        static bool ValueAlmost0(float v) => M.Approximately(v, 0);
        ...
        public static Polynomial Lerp(Polynomial a, Polynomial b, float t) => new(t.Lerp(a.c0, b.c0), t.Lerp(a.c1, b.c1), t.Lerp(a.c2, b.c2), t.Lerp(a.c3, b.c3));
        ...
        public static explicit operator BezierQuad1D(Polynomial poly) =>
            poly.Degree < 3
                ? new BezierQuad1D(CharMatrix.quadraticBezierInverse * (Matrix3x1) poly)
