...
namespace Pancake.Common {
	...
	public static class IParamCurve2DiffExt2D {
		...
		/// <param name="t">The t-value along the curve to sample</param>
		[MethodImpl( INLINE )] public static float EvalCurvature<T>( this T curve, float t ) where T : IParamCurve2Diff<Vector2> => M.GetCurvature( curve.EvalDerivative( t ), curve.EvalSecondDerivative( t ) );
	...
	public static class IParamCurve2DiffExt3D {
		...
		/// <param name="t">The t-value along the curve to sample</param>
		[MethodImpl( INLINE )] public static Vector3 EvalCurvature<T>( this T curve, float t ) where T : IParamCurve2Diff<Vector3> => M.GetCurvature( curve.EvalDerivative( t ), curve.EvalSecondDerivative( t ) );
		...
		/// <param name="t">The t-value along the curve to sample</param>
		[MethodImpl( INLINE )] public static Vector3 EvalArcNormal<T>( this T curve, float t ) where T : IParamCurve2Diff<Vector3> => M.GetArcNormal( curve.EvalDerivative( t ), curve.EvalSecondDerivative( t ) );

		/// <summary>Returns the frenet-serret (curvature-based) binormal direction at the given t-value on the curve</summary>
		/// <param name="t">The t-value along the curve to sample</param>
		[MethodImpl( INLINE )] public static Vector3 EvalArcBinormal<T>( this T curve, float t ) where T : IParamCurve2Diff<Vector3> => M.GetArcBinormal( curve.EvalDerivative( t ), curve.EvalSecondDerivative( t ) );
		...
		/// <param name="t">The t-value along the curve to sample</param>
		[MethodImpl( INLINE )] public static Quaternion EvalArcOrientation<T>( this T curve, float t ) where T : IParamCurve2Diff<Vector3> => M.GetArcOrientation( curve.EvalDerivative( t ), curve.EvalSecondDerivative( t ) );
	...
	public static class IParamCurve3DiffExt3D {
		...
		/// <param name="t">The t-value along the curve to sample</param>
		[MethodImpl( INLINE )] public static float EvalTorsion<T>( this T curve, float t ) where T : IParamCurve3Diff<Vector3> => M.GetTorsion( curve.EvalDerivative( t ), curve.EvalSecondDerivative( t ), curve.EvalThirdDerivative( t ) );
	}
