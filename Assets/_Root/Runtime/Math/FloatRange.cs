...
namespace Pancake.Common
{
    ...
    public readonly struct FloatRange
    {
        ...
        public float Lerp(float t) => M.Lerp(a, b, t);
        ...
        public float InverseLerp(float v) => M.InverseLerp(a, b, v);
        ...
        {
            float separation = M.Abs(other.Center - Center);
        ...
        public FloatRange Encapsulate(float value) =>
            Direction switch
            {
                1 => (M.Min(a, value), M.Max(b, value)), // forward - a is min, b is max
                _ => (M.Min(b, value), M.Max(a, value)) // reversed - b is min, a is max
            };
