...
namespace Pancake.Common
{
    ...
    public partial struct Circle2D
    {
        ...
        [MethodImpl(INLINE)]
        public static Circle2D FromTwoPoints(Vector2 a, Vector2 b) => new Circle2D((a + b) / 2f, Vector2.Distance(a, b) / 2f);
    }
    ...
    public partial struct Circle2D
    {
        ...
        [MethodImpl(INLINE)]
        public bool Intersects<T>(T linear) where T : ILinear2D => IntersectionTest.LinearCircleIntersects(linear, this);
        ...
        [MethodImpl(INLINE)]
        public bool Intersects(Circle2D circle) => IntersectionTest.CirclesOverlap(this.center, this.radius, circle.center, circle.radius);

        /// <summary>Returns the intersections this circle has with a linear object (if any)</summary>
        /// <param name="linear">The linear object to test intersection against (Ray2D, Line2D or LineSegment2D)</param>
        [MethodImpl(INLINE)]
        public ResultsMax2<Vector2> Intersect<T>(T linear) where T : ILinear2D => IntersectionTest.LinearCircleIntersectionPoints(linear, this);

        /// <summary>Returns the intersections this circle has with another circle (if any)</summary>
        /// <param name="circle">The circle to test intersection against</param>
        [MethodImpl(INLINE)]
        public ResultsMax2<Vector2> Intersect(Circle2D circle) => IntersectionTest.CirclesIntersectionPoints(this.center, this.radius, circle.center, circle.radius);
    }
