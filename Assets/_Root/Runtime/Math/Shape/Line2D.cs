...
namespace Pancake.Common
{
    ...
    public struct Line2D : ILinear2D
    {
        ...
        [MethodImpl(INLINE)]
        float ILinear2D.ClampTValue(float t) => t; // :)
        ...
        [MethodImpl(INLINE)]
        public static float PointToPlaneSignedDistance(Vector2 planeOrigin, Vector2 planeNormal, Vector2 point) { return Vector2.Dot(point - planeOrigin, planeNormal); }
