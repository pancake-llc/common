...
namespace Pancake.Common
{
    ...
    public static class ExtILinear2D
    {
        ...
        [MethodImpl(INLINE)]
        public static Vector2 GetPoint<T>(this T linear, float t) where T : ILinear2D { return linear.Origin + linear.Dir * t; }
        ...
        [MethodImpl(INLINE)]
        public static float ProjectPointTValue<T>(this T linear, Vector2 point) where T : ILinear2D
        {
        ...
        [MethodImpl(INLINE)]
        public static Vector2 ProjectPoint<T>(this T linear, Vector2 point) where T : ILinear2D { return linear.GetPoint(linear.ProjectPointTValue(point)); }
        ...
        [MethodImpl(INLINE)]
        public static float Distance<T>(this T linear, Vector2 point) where T : ILinear2D { return Vector2.Distance(point, linear.ProjectPoint(point)); }
        ...
        [MethodImpl(INLINE)]
        public static bool Intersect<T, U>(this T linear, U other, out Vector2 intersectionPoint) where T : ILinear2D where U : ILinear2D =>
            IntersectionTest.LinearIntersectionPoint(linear, other, out intersectionPoint);

        /// <summary>Returns the intersections this line has with a circle (if any)</summary>
        /// <param name="linear">The linear object to test intersection with (Ray2D, Line2D or LineSegment2D)</param>
        /// <param name="circle">The circle to test intersection against</param>
        [MethodImpl(INLINE)]
        public static ResultsMax2<Vector2> Intersect<T>(this T linear, Circle2D circle) where T : ILinear2D =>
            IntersectionTest.LinearCircleIntersectionPoints(linear, circle);
