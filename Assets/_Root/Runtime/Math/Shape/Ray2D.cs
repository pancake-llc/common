...
namespace Pancake.Common
{
    ...
    public struct Ray2D : ILinear2D
    {
        ...
        /// <summary>Implicitly casts a Unity ray to a M ray</summary>
        ...
        /// <summary>Implicitly casts a M ray to a Unity ray</summary>
        /// <param name="ray">The ray to cast to a M ray</param>
        ...
        [MethodImpl(INLINE)]
        bool ILinear2D.IsValidTValue(float t) => t >= 0;

        [MethodImpl(INLINE)]
        float ILinear2D.ClampTValue(float t) => t < 0 ? 0 : t;
