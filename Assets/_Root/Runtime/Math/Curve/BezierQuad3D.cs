...
namespace Pancake.Common
{
    ...
    [Serializable]
    public struct BezierQuad3D : IParamCurve2Diff<Vector3>
    {
        ...
        [SerializeField] private Vector3 p0, p1, p2; // the points of the curve
        ...
        [NonSerialized] private Vector3 c2, c1; // cached coefficients for fast evaluation. c0 = p0
        ...
        [MethodImpl(INLINE)]
        public (Vector3 c2, Vector3 c1, Vector3 c0) GetCoefficients()
        {
            ReadyCoefficients();
            return (c2, c1, p0);
        }
