...
namespace Pancake.Common
{
    ...
    public static class IParamCurve1DiffExt2D
    {
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Vector2 GetTangent<T>(this T curve, float t) where T : IParamCurve1Diff<Vector2> => curve.GetDerivative(t).normalized;
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Vector2 GetNormal<T>(this T curve, float t) where T : IParamCurve1Diff<Vector2> => curve.GetTangent(t).Rotate90CCW();

        /// <summary>Returns the 2D angle of the direction of the curve at the given point, in radians</summary>
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static float GetAngle<T>(this T curve, float t) where T : IParamCurve1Diff<Vector2> => DirToAng(curve.GetDerivative(t));

        /// <summary>Returns the orientation at the given point t, where the X axis is tangent to the curve</summary>
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Quaternion GetOrientation<T>(this T curve, float t) where T : IParamCurve1Diff<Vector2> => DirToOrientation(curve.GetDerivative(t));

        /// <summary>Returns the position and orientation at the given t-value on the curve</summary>
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Pose GetPose<T>(this T curve, float t) where T : IParamCurve1Diff<Vector2> => PointDirToPose(curve.GetPoint(t), curve.GetTangent(t));

        /// <summary>Returns the position and orientation at the given t-value on the curve, expressed as a matrix</summary>
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Matrix4x4 GetMatrix<T>(this T curve, float t) where T : IParamCurve1Diff<Vector2> =>
            GetMatrixFrom2DPointDir(curve.GetPoint(t), curve.GetTangent(t));
    }
    ...
    public static class IParamCurve1DiffExt3D
    {
        ...
        [MethodImpl(INLINE)]
        public static Vector3 GetTangent<T>(this T curve, float t) where T : IParamCurve1Diff<Vector3> => curve.GetDerivative(t).normalized;
        ...
        [MethodImpl(INLINE)]
        public static Vector3 GetNormal<T>(this T curve, float t, Vector3 up) where T : IParamCurve1Diff<Vector3> => GetNormalFromLookTangent(curve.GetDerivative(t), up);
        ...
        [MethodImpl(INLINE)]
        public static Vector3 GetBinormal<T>(this T curve, float t, Vector3 up) where T : IParamCurve1Diff<Vector3> =>
            GetBinormalFromLookTangent(curve.GetDerivative(t), up);
        ...
        [MethodImpl(INLINE)]
        public static Quaternion GetOrientation<T>(this T curve, float t, Vector3 up) where T : IParamCurve1Diff<Vector3> =>
            Quaternion.LookRotation(curve.GetDerivative(t), up);
        ...
        /// <param name="up">The reference up vector. The Y axis will attempt to be as aligned with this vector as much as possible</param>
        [MethodImpl(INLINE)]
        public static Pose GetPose<T>(this T curve, float t, Vector3 up) where T : IParamCurve1Diff<Vector3> =>
            new Pose(curve.GetPoint(t), Quaternion.LookRotation(curve.GetDerivative(t), up));
    ...
    public static class IParamCurve2DiffExt2D
    {
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static float GetCurvature<T>(this T curve, float t) where T : IParamCurve2Diff<Vector2> =>
            M.GetCurvature(curve.GetDerivative(t), curve.GetSecondDerivative(t));
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Circle2D GetOsculatingCircle<T>(this T curve, float t) where T : IParamCurve2Diff<Vector2> =>
            Circle2D.GetOsculatingCircle(curve.GetPoint(t), curve.GetDerivative(t), curve.GetSecondDerivative(t));
    }
    ...
    public static class IParamCurve2DiffExt3D
    {
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Vector3 GetCurvature<T>(this T curve, float t) where T : IParamCurve2Diff<Vector3> =>
            M.GetCurvature(curve.GetDerivative(t), curve.GetSecondDerivative(t));

        /// <inheritdoc cref="IParamCurve2DiffExt2D.GetOsculatingCircle{T}(T,float)"/>
        [MethodImpl(INLINE)]
        public static Circle3D GetOsculatingCircle<T>(this T curve, float t) where T : IParamCurve2Diff<Vector3> =>
            Circle3D.GetOsculatingCircle(curve.GetPoint(t), curve.GetDerivative(t), curve.GetSecondDerivative(t));

        /// <summary>Returns the frenet-serret (curvature-based) normal direction at the given t-value on the curve</summary>
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Vector3 GetArcNormal<T>(this T curve, float t) where T : IParamCurve2Diff<Vector3> =>
            M.GetArcNormal(curve.GetDerivative(t), curve.GetSecondDerivative(t));

        /// <summary>Returns the frenet-serret (curvature-based) binormal direction at the given t-value on the curve</summary>
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Vector3 GetArcBinormal<T>(this T curve, float t) where T : IParamCurve2Diff<Vector3> =>
            M.GetArcBinormal(curve.GetDerivative(t), curve.GetSecondDerivative(t));
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Quaternion GetArcOrientation<T>(this T curve, float t) where T : IParamCurve2Diff<Vector3> =>
            M.GetArcOrientation(curve.GetDerivative(t), curve.GetSecondDerivative(t));
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static Pose GetArcPose<T>(this T curve, float t) where T : IParamCurve2Diff<Vector3>
        {
    ...
    public static class IParamCurve3DiffExt3D
    {
        ...
        /// <param name="t">The t-value along the curve to sample</param>
        [MethodImpl(INLINE)]
        public static float GetTorsion<T>(this T curve, float t) where T : IParamCurve3Diff<Vector3> =>
            M.GetTorsion(curve.GetDerivative(t), curve.GetSecondDerivative(t), curve.GetThirdDerivative(t));
    }
}