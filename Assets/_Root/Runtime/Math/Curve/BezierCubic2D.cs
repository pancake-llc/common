...
namespace Pancake.Common
{
    ...
    [Serializable]
    public struct BezierCubic2D : IParamCurve3Diff<Vector2>
    {
        ...
        [SerializeField] private Vector2 p0, p1, p2, p3; // the points of the curve
        ...
        [NonSerialized] private Vector2 c3, c2, c1; // cached coefficients for fast evaluation. c0 = p0
        ...
        [MethodImpl(INLINE)]
        public (Vector2 c3, Vector2 c2, Vector2 c1, Vector2 c0) GetCoefficients()
        {
            ReadyCoefficients();
            return (c3, c2, c1, p0);
        }
        ...
        [MethodImpl(INLINE)]
        public Vector2 GetStartPoint() => p0;

        [MethodImpl(INLINE)]
        public Vector2 GetEndPoint() => p3;
        ...
        [MethodImpl(INLINE)]
        public Vector2 GetThirdDerivative(float t = 0)
        {
            ReadyCoefficients();
