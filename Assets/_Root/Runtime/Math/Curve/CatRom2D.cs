...
namespace Pancake.Common
{
    ...
    [Serializable]
    public struct CatRom2D
    {
        private const MethodImplOptions INLINE = MethodImplOptions.AggressiveInlining;

        // serialized data
        [SerializeField] private Vector2 p0, p1, p2, p3;
        [SerializeField] private float k0, k1, k2, k3; // knots
        [SerializeField] [Range(0, 1)] private float alpha;
        [SerializeField] [Range(0, 1)] private float tension;
        [SerializeField] private bool manualKnots;
        ...
        [NonSerialized] private Vector2 c3, c2, c1, c0; // cached coefficients for fast evaluation
        ...
        public Vector2 GetPoint( float t, float alpha ) {
            ...
            float v = M.Lerp( k1, k2, t ); // remap from 0-1 to k1-k2
        ...
        Vector2 Remap( float value, float t0, float t1, Vector2 a, Vector2 b ) {
            float t = M.InverseLerp( t0, t1, value );
