...
namespace Pancake.Common
{
    public readonly struct CharMatrix
    {
        ...
        public static readonly CharMatrix3x3 quadraticBezier = new(1,
            0,
            0,
            -2,
            2,
        ...
        public static readonly CharMatrix4x4 cubicBezier = new(1,
            0,
            0,
            0,
            -3,
        ...
        public static readonly CharMatrix4x4 cubicBezierInverse = new CharMatrix4x4(3,
            0,
            0,
            0,
            3,
        ...
        public static readonly CharMatrix4x4 cubicHermite = new(1,
            0,
            0,
            0,
            0,
        ...
        public static readonly CharMatrix4x4 cubicHermiteInverse = new(1,
            0,
            0,
            0,
            0,
        ...
        public static readonly CharMatrix4x4 cubicCatmullRom = new CharMatrix4x4(0,
            2,
            0,
            0,
            -1,
        ...
        public static readonly CharMatrix4x4 cubicCatmullRomInverse = new CharMatrix4x4(1,
            -1,
            1,
            1,
            1,
        ...
        public static readonly CharMatrix4x4 cubicUniformBspline = new CharMatrix4x4(1,
            4,
            1,
            0,
            -3,
        ...
        public static readonly CharMatrix4x4 cubicUniformBsplineInverse = new CharMatrix4x4(3,
            -3,
            2,
            0,
            3,
    ...
    public readonly struct CharMatrix4x4
    {
        ...
        public Polynomial GetEvalPolynomial(float p0, float p1, float p2, float p3) =>
            new(p0 * m00 + p1 * m01 + p2 * m02 + p3 * m03,
        ...
        public Polynomial3D GetCurve(Vector3 p0, Vector3 p1, Vector3 p2, Vector3 p3) =>
            new(GetEvalPolynomial(p0.x, p1.x, p2.x, p3.x), GetEvalPolynomial(p0.y, p1.y, p2.y, p3.y), GetEvalPolynomial(p0.z, p1.z, p2.z, p3.z));
        ...
        public (float, float, float, float) MultiplyColumnVec(float p0, float p1, float p2, float p3) =>
            (p0 * m00 + p1 * m01 + p2 * m02 + p3 * m03, p0 * m10 + p1 * m11 + p2 * m12 + p3 * m13, p0 * m20 + p1 * m21 + p2 * m22 + p3 * m23,
                p0 * m30 + p1 * m31 + p2 * m32 + p3 * m33);
        ...
        public (Vector2, Vector2, Vector2, Vector2) MultiplyColumnVec(Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3)
        {
            ...
            return (new Vector2(x0, y0), new Vector2(x1, y1), new Vector2(x2, y2), new Vector2(x3, y3));
        }
    ...
    public readonly struct CharMatrix3x3
    {
        ...
        public Polynomial GetEvalPolynomial(float p0, float p1, float p2) =>
            Polynomial.Quadratic(p0 * m00 + p1 * m01 + p2 * m02, p0 * m10 + p1 * m11 + p2 * m12, p0 * m20 + p1 * m21 + p2 * m22);

        /// <inheritdoc cref="CharMatrix4x4.GetCurve(Vector2,Vector2,Vector2,Vector2)"/>
        public Polynomial2D GetCurve(Vector2 p0, Vector2 p1, Vector2 p2) => new(GetEvalPolynomial(p0.x, p1.x, p2.x), GetEvalPolynomial(p0.y, p1.y, p2.y));

        /// <inheritdoc cref="CharMatrix4x4.GetCurve(Vector2,Vector2,Vector2,Vector2)"/>
        public Polynomial3D GetCurve(Vector3 p0, Vector3 p1, Vector3 p2) =>
            new(GetEvalPolynomial(p0.x, p1.x, p2.x), GetEvalPolynomial(p0.y, p1.y, p2.y), GetEvalPolynomial(p0.z, p1.z, p2.z));
    }
}