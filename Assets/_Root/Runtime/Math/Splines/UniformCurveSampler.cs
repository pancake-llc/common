...
namespace Pancake.Common
{
    ...
    public class UniformCurveSampler
    {
        ...
        public UniformCurveSampler(Polynomial2D curve, int resolution = 12)
            : this(curve, FloatRange.unit, resolution)
        {
        }
        ...
        public UniformCurveSampler(Polynomial3D curve, int resolution = 12)
            : this(curve, FloatRange.unit, resolution)
        {
        }
        ...
        public float DistanceToParam(float distance)
        {
            ...
            if (distance.Between(0, CurveIntervalLength))
            {
                ...
                for (int i = 0; i < resolution - 1; i++)
                {
                    ...
                    {
                        // check if our input distance lies between the two distances
