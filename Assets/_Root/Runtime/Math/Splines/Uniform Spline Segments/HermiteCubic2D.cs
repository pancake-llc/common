...
namespace Pancake.Common {
	...
	[Serializable] public struct HermiteCubic2D : IParamSplineSegment<Polynomial2D,Vector2Matrix4x1> {
		...
		public HermiteCubic2D( Vector2 p0, Vector2 v0, Vector2 p1, Vector2 v1 ) => (pointMatrix,curve,validCoefficients) = (new Vector2Matrix4x1(p0, v0, p1, v1),default,false);
		...
		public Vector2 V0{ [MethodImpl( INLINE )] get => pointMatrix.m1; [MethodImpl( INLINE )] set => _ = ( pointMatrix.m1 = value, validCoefficients = false ); }
		/// <summary>The end point of the curve</summary>
		public Vector2 P1{ [MethodImpl( INLINE )] get => pointMatrix.m2; [MethodImpl( INLINE )] set => _ = ( pointMatrix.m2 = value, validCoefficients = false ); }
		/// <summary>The rate of change (velocity) at the end of the curve</summary>
		public Vector2 V1{ [MethodImpl( INLINE )] get => pointMatrix.m3; [MethodImpl( INLINE )] set => _ = ( pointMatrix.m3 = value, validCoefficients = false ); }
