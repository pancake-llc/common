...
namespace Pancake.Common {
	...
	[Serializable] public struct CatRomCubic2D : IParamSplineSegment<Polynomial2D,Vector2Matrix4x1> {
		...
		public CatRomCubic2D( Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3 ) => (pointMatrix,curve,validCoefficients) = (new Vector2Matrix4x1(p0, p1, p2, p3),default,false);
		...
		public static bool operator ==( CatRomCubic2D a, CatRomCubic2D b ) => a.pointMatrix == b.pointMatrix;
		...
		public override bool Equals( object obj ) => obj is CatRomCubic2D other && pointMatrix.Equals( other.pointMatrix );
