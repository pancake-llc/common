...
namespace Pancake.Common
{
    ...
    [Serializable]
    public struct CatRomCubic2D : IParamCubicSplineSegment2D
    {
        ...
        {
            return new CatRomCubic2D(Vector2.LerpUnclamped(a.p0, b.p0, t),
        ...
        public BezierCubic2D ToBezier() => new BezierCubic2D(p1, p1 + (p2 - p0) / 6f, p2 + (p1 - p3) / 6f, p2);

        /// <summary>Returns the hermite representation of the same curve</summary>
        public HermiteCubic2D ToHermite() => new HermiteCubic2D(p1, (p2 - p0) / 2f, p2, (p3 - p1) / 2f);

        /// <summary>Returns the bspline representation of the same curve</summary>
        public UBSCubic2D ToBSpline() =>
            new UBSCubic2D((7 * p0 - 4 * p1 + 5 * p2 - 2 * p3) / 6,
