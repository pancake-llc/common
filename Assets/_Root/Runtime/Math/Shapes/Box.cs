...
namespace Pancake.Common
{
    ...
    public partial struct Box2D
    {
        ...
        [MethodImpl(INLINE)]
        public bool Contains(Vector2 point) => Abs(point.x) - extents.x <= 0 && Abs(point.y) - extents.y <= 0;
    }
    ...
    public partial struct Box3D
    {
        ...
        [MethodImpl(INLINE)]
        public bool Contains(Vector3 point) => Abs(point.x) - extents.x <= 0 && Abs(point.y) - extents.y <= 0 && Abs(point.z) - extents.z <= 0;
    }
    ...
    public partial struct Box2D
    {
        ...
        public Vector2 ClosestCorner(Vector2 point) => new Vector2(center.x + Sign(point.x - center.x) * extents.x, center.y + Sign(point.y - center.y) * extents.y);
    }
    ...
    public partial struct Box3D
    {
        ...
        public Vector3 ClosestCorner(Vector3 point) =>
            new Vector3(center.x + Sign(point.x - center.x) * extents.x,
    ...
    public partial struct Box2D
    {
        ...
        public Vector2 ClosestPointInside(Vector2 point) =>
            new Vector2(point.x.Clamp(center.x - extents.x, center.x + extents.x), point.y.Clamp(center.y - extents.y, center.y + extents.y));
    }
    ...
    public partial struct Box3D
    {
        ...
        public Vector3 ClosestPointInside(Vector3 point) =>
            new Vector3(point.x.Clamp(center.x - extents.x, center.x + extents.x),
    ...
    public partial struct Box2D
    {
        ...
        public Vector2 ClosestPointOnBoundary(Vector2 point)
        {
            ...
            return new Vector2(center.x + Sign(px) * (caseX ? extents.x : ax.AtMost(extents.x)), center.y + Sign(py) * (caseY ? extents.y : ay.AtMost(extents.y)));
        }
    }
    ...
    public partial struct Box3D
    {
        ...
        public Vector3 ClosestPointOnBoundary(Vector3 point)
        {
            ...
            return new Vector3(center.x + Sign(px) * (caseX ? extents.x : ax.AtMost(extents.x)),
