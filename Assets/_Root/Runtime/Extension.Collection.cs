...
namespace Pancake.Common
{
    public static partial class C
    {
        ...
        /// <typeparam name="TValue"></typeparam>
        /// <returns></returns>
        public static System.Collections.Generic.List<TValue> EnsureList<TKey, TValue>(
            this System.Collections.Generic.IDictionary<TKey, System.Collections.Generic.List<TValue>> source,
            TKey key)
        {
            //do not use Ensure for performance and GC reasons
            source.TryGetValue(key, out var result);
